...
Beyond code: I'm **married with one child**, stay active with **CrossFit** (about three sessions per week), **OCR Tribalion**, and **weekend runs** with my daughter; my background includes **wood processing (Forestry faculty, Belgrade)**, **facility / operations management**, and hands-on **DIY**. For more on hobbies, family, and that background, ask the site **assistant** (icon in the corner).
...
If you’re skimming quickly: start at [**Projects**](/projects) for repos, **[Lab](/lab)** for deploy links, [**Diplomas & certificates**](#credentials) below for scans, [**CV**](/cv) for a printable resume, and [**Contact**](/contact) to reach out.
