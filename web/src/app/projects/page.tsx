...
function GitHubRepoCard({
  ...
  return (
    ...
    <article className="flex h-full flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-5 transition hover:border-cyan-500/30 hover:bg-white/[0.06]">
...
export default async function ProjectsPage() {
  ...
  type GhOk = {
    ...
    r: Awaited<ReturnType<typeof fetchUserRepos>>;
  ...
  return (
    ...
    <Section eyebrow="Portfolio" title="Projekti">
      ...
      <div
        ...
        className="mb-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
      ...
      <ul className="grid gap-4 sm:grid-cols-2">
        ...
        {projectRows.map((row) =>
          ...
          row.kind === "manual" ? (
            ...
            <li key={row.project.id} className="h-full min-h-0">
            ...
            <li key={row.repo.id} className="h-full min-h-0">
